...
public class CriterioBusqueda {
  ...
  public List<String> getTemporadas() {
    return Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList(RecetaBuilder.INVIERNO, RecetaBuilder.PRIMAVERA, RecetaBuilder.VERANO, RecetaBuilder.OTOÑO, RecetaBuilder.TODOELAÑO));
  }
  ...
  public void filtrarPorDificultad() {
    boolean _equals = Objects.equal(this.dificultad, null);
    boolean _not = (!_equals);
    if (_not) {
